...
export const coastalGLSL = /* glsl */ `
  ...
  float coastalDepth(vec2 p) { return max(0.05, -texture2D(uHeightMap, clamp(p / 1100.0 + vec2(0.5), vec2(0.001), vec2(0.999))).r); }
