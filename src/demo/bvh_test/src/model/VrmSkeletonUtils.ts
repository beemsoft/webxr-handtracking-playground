...
export default class VrmSkeletonUtils {
  ...
  static retarget(target, source, options) {
    ...
    this.retargetBone(bones, options, sourceBones, target, bindBones, 6);
    ...
    this.retargetBone(bones, options, sourceBones, target, bindBones, 39);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 40);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 46);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 47);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 48);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 41);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 42);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 43);
    this.retargetBone(bones, options, sourceBones, target, bindBones, 15);
    ...
    this.retargetBone(bones, options, sourceBones, target, bindBones, 24);
  };
