...
class RenderPass extends Pass {
	...
	constructor( scene, camera, baseRenderTarget, overrideMaterial, clearColor, clearAlpha ) {
	...
	render( renderer, writeBuffer, readBuffer /*, deltaTime, maskActive */ ) {
		...
		renderer.setRenderTarget( this.renderToScreen ? this.baseRenderTarget : readBuffer );
